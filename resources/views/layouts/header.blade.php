<header id="site_menu_header" class="site-header d-none">
    <div class="main-logo">
        <a href="{{ route('home') }}" data-dsn-text="mexdot" class="custom-logo-link main-brand effect-ajax" rel="home" aria-current="page">
            <!-- <img src="{{ asset('assets/img/logo-light.png') }}" class="custom-logo logo-light" alt="mexdot" />
            <img src="{{ asset('assets/img/logo.png') }}" class="custom-logo logo-dark" alt="mexdot" /> -->
        </a>
    </div>
    <nav class="main-navigation ">
        ...
        <ul id="dsn-primary-list" class="primary-nav h2">
            ...
            <li class="nav-item has-sub-menu">
                <a title="Home" href="{{ route('photo') }}">
                    <span class="overflow ">Portfolio</span>
                </a>  
            </li>

            <li class="nav-item has-sub-menu">
                <a title="Home" href="{{ route('project-7') }}">
